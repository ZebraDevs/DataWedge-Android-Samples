package com.zebra.sample.multifragmentsample1.ui.adapter
...
import com.zebra.sample.multifragmentsample1.databinding.LayoutResultBinding
...
class ItemAdapter :
    ...
    class OutputViewHolder(val binding: LayoutResultBinding) :
        ...
        fun bind(dwOutputData: DWOutputData) {
            binding.data = dwOutputData.data
